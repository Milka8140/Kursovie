...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 19 2023 г., 21:28
...
CREATE TABLE `comments` (
  `id` int(11) NOT NULL,
  `author_login` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `orderss` (
  ...
  `phon` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `desс` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `data` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
